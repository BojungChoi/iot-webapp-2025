...
namespace MyPortfolioWebApp.Controllers
{
    public class BoardController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Eamil,Writer,Title,Contents,PostDate,ReadCount")] Board board)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Eamil,Writer,Title,Contents,PostDate,ReadCount")] Board board)
        {
            if (id != board.Id)
            {
                return NotFound();
